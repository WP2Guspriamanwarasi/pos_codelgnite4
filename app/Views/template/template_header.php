...
<head>
  ...
  <title>Admin men | <?php echo $title  ?></title>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="<?=site_url()?>">Guspriaman Warasi</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item <?php if(in_array($activeMenu, ['supplier'])){
                echo "menu-open";
                }?>">
              <a href="<?php echo site_url('supplier') ?>" class="nav-link <?php if ($activeMenu == 'supplier') echo "active"; ?>">
